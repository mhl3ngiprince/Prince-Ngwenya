        ...
        <div className="footer-content">
          ...
          <nav className="footer-nav" aria-label="Footer navigation">
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                <li><a href="https://github.com/mhl3ngiprince" target="_blank" rel="noreferrer noopener" className="footer-link">GitHub</a></li>
                <li><a href="https://www.linkedin.com/in/mhlengie-prince-ngwenya-728878268/" target="_blank" rel="noreferrer noopener" className="footer-link">LinkedIn</a></li>
